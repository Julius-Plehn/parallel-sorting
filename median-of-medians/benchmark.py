...
if __name__ == "__main__":
    ...
    for size in sizes:
        ...
        timing_sorted = timeit.timeit(stmt="sorting.insertion_sort(input.copy())", globals=globals(), number=repeat)
        ...
        for r in rs:
            ...
            timing_median = timeit.timeit(stmt="sorting.quicksort_median(input.copy(), 0, len(input)-1, r=r)", globals=globals(), number=repeat)
